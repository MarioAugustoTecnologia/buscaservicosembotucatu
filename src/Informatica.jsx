...
const Informatica = () => {
  ...
  const handleWhatsAppClickTwo = () => {

    var fone = document.getElementById('fone2').textContent;
    console.log(fone)
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div class="container-cards d-flex" style={{ width: '800px', margin: '0 220px', height: '200px' }}>
        ...
        <div class="card" style={{ backgroundColor: 'green', width: '350px', margin: '0 40px', height: '250px' }}>

          <div class="card-conteudo" style={{ color: 'white', margin: '0 20px' }}>
            <br />
            <center><h4>Teófanes Trombini</h4></center>
            <center><i class="bi bi-pc-display-horizontal ms-2 fs-1"></i></center>
            <p> - Assistência Técnica em Computadores:</p>
            <p>- Vendas:</p>
            <p onClick={handleWhatsAppClickTwo} id='fone2' style={{ cursor: 'pointer' }}><i class="bi bi-whatsapp fs-5 ms-2" style={{ color: 'lime' }}></i>      (14) 996429113</p>
